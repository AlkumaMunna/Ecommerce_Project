    ...
    if request.method == "GET":
        ...
        if coupon_code:
            try:
                ...
                order_total = order_total - (order_total * coupon_discount / 100)
            except:
                invalid_coupon = "Invalid Coupon Code!"
                order_total = order_qs[0].get_totals()

    return render(request, 'App_Payment/checkout.html', context={'form': form, "order_items": order_items, "order_total": order_total, "saved_address": saved_address, "coupon": coupon, "valid_coupon": valid_coupon, "invalid_coupon": invalid_coupon,})
...
def payment(request):
    ...
    store_id = 'abcco64e22d987e4ca'
    API_key = 'abcco64e22d987e4ca@ssl'
